...
const ServiceCard = ({ index, title, icon, source_link, color }) => {
  return (
    <Tilt
      options={{ reverse: true, max: 15, scale: 1.02, speed: 400 }}
      className="w-full sm:w-[250px] group"
    >
      <motion.div
      ...
      >
        ...
        >
          <img
            ...
            alt={title}
            aria-hidden="true"
            className="w-16 h-16 object-contain grayscale opacity-90 group-hover:opacity-100 group-hover:grayscale-0 transition-opacity group-hover:scale-110 duration-300"
          />
  ...
  return (
    <div className="w-full flex flex-col gap-12 md:gap-16 mb-20">
      ...
      >
        ...
        <h2
          className={`text-slate-900 font-black md:text-[70px] sm:text-[60px] text-4xl uppercase tracking-tighter leading-[1.1] mt-2`}
        >
          Let&apos;s Talk.
        </h2>
      </motion.div>
