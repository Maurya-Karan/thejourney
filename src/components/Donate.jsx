...
const Donate = () => {
    ...
    async function payNow(e) {
        ...
        const response = await fetch('https://a743-174-129-135-255.ngrok-free.app/create-order', {
          method: 'POST',
          headers: {
        ...
        const options = {
          ...
          callback_url: 'https://a743-174-129-135-255.ngrok-free.app/payment-success', // Your success URL
          prefill: {
            name: '',
            email: '',
            contact: ''
          ...
          handler: function (response) {
            fetch('https://a743-174-129-135-255.ngrok-free.app/verify-payment', {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json'
              },
              ...
              .then(data => {
                if (data.status === 'ok') {
                  window.location.href = 'https://a743-174-129-135-255.ngrok-free.app/payment-success';
                } else {
